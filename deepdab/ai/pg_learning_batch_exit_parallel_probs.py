...
def run_episodes(num_episodes_per_thread, existing_params, temperature):
    ...
    for episode_num in range(1, num_episodes_per_thread + 1):
        ...
        append_prob_transitions(p0_states, p0_action_prob_maps, p0_outcomes, run_transitions, use_symmetries)
        p1_outcomes = len(p1_action_prob_maps)*[1]
        append_prob_transitions(p1_states, p1_action_prob_maps, p1_outcomes, run_transitions, use_symmetries)
