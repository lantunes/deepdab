...
epsilon_schedule = {0: 0.0}
opponent_epsilon = 0.2
batch_size = 32
decay_speed = 1.0
opponent_pool_max_size = 1
num_episodes_per_policy_update = 500
num_episodes_per_opponent_cache = 25000
...
policy = PGPolicy3x3CNN(board_size, batch_size=batch_size, dropout_keep_prob=dropout_keep_prob, existing_params=pg_params)
...
for episode_num in range(1, num_episodes + 1):
    ...
    opponent.set_epsilon(opponent_epsilon)
    ...
    while not game.is_finished():
        ...
        if current_player == 'policy':
            ...
            action_prob_map = policy.get_action_probs(board_state, normalize_policy_probs_with_softmax)
