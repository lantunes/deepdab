...
class TDOneGradientPolicyCNNV2b(Policy):
    """
    ...
    def __init__(self, board_size):
        ...
        self._sum_grad_W_in = tf.placeholder("float", shape=[5 * 5 * 12, self._n_hidden], name="sum_grad_W_in")
        ...
        self._conv_flat = tf.reshape(self._conv, [1, 5 * 5 * 12])
